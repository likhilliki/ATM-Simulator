...
export default function DepositPage() {
  const { navigateTo, setDepositAmount, showNotification } = useATM();
  ...
  const handleConfirm = () => {
    ...
    if (showCustomInput) {
      ...
      if (!parsed || isNaN(parsed) || parsed < 10 || parsed > 10000) {
        showNotification("Please enter a valid amount (minimum $10, maximum $10,000)", "error");
        return;
      }
      amount = parsed;
  ...
  return (
    <div className="fade-in">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-bold">Cash Deposit</h2>
      </div>
      
      <div className="text-sm text-gray-600 mb-4">
        Please select an amount to deposit or enter a custom amount
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-3 mb-6">
        ...
        <div className="flex justify-between items-center mt-1">
          <div className="text-sm">Daily Deposit Limit:</div>
